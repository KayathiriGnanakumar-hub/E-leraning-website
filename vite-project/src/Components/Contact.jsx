...
export default function Contact() {
  return (
    <div
      id="contact"
      className="bg-[#F5F3FF] px-6 py-12 min-h-screen"
    >
      {/* PAGE TITLE */}
        ...
        <div className="grid md:grid-cols-2 gap-9 items-stretch">
          ...
          <div className="bg-white rounded-xl shadow p-5 flex flex-col">
            <img
              ...
              mx-auto mb-5 rounded-lg shadow ring-1 ring-purple-200"
            />
          ...
          <div className="bg-white rounded-xl shadow p-5 flex flex-col">
            ...
            <select
              className="w-full border rounded-lg px-3 py-2 mb-3 text-sm
              focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-600"
            >
